...
public class ServletTest extends HttpServlet {
	...
	if(player.equals("1")){
		...
		channelService1.sendMessage(new ChannelMessage("player1", "bang"));
	}
	if(player.equals("2")){
		ChannelService channelService2 = ChannelServiceFactory.getChannelService();
		channelService2.sendMessage(new ChannelMessage("player2", "bang"));
	}
	if(player.equals("3")){
		ChannelService channelService3 = ChannelServiceFactory.getChannelService();
		channelService3.sendMessage(new ChannelMessage("player3", "bang"));
	}
	if(player.equals("4")){
		ChannelService channelService4 = ChannelServiceFactory.getChannelService();
		channelService4.sendMessage(new ChannelMessage("player4", "bang"));
	}
